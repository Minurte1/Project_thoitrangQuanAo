...
function NoiDungTuyenDung() {
  return (
    <div className="container-tuyendung">
      ...
      <p>
        <span className="logotuyendung">Quần Áo</span>, một thương hiệu thời trang nổi
        tiếng và đang phát triển mạnh mẽ, hiện đang mở cửa để chào đón các bạn
        trẻ năng động và đam mê marketing tham gia vào đội ngũ của chúng tôi.
        Hãy cùng nhau xây dựng sự thành công và lan tỏa đam mê thời trang đến cộng
        đồng.
      </p>
      ...
      <div className="job-description">
        ...
        <ul>
          <li>
            Tìm kiếm và tư vấn khách hàng có nhu cầu về thời trang dép, cả offline và
            online.
          </li>
          <li>
            Phát triển kế hoạch marketing sáng tạo và hiệu quả cho cửa hàng.
          </li>
          <li>
            Xây dựng và duy trì mối quan hệ khách hàng, hỗ trợ chăm sóc doanh
            nghiệp và chủ shop.
          </li>
          <li>
            Điều phối công việc với bộ phận thực hiện marketing để giải quyết
            nhanh chóng mọi khúc mắc của khách hàng.
          </li>
        </ul>
      </div>
      ...
      <div className="benefits">
        ...
        <ul>
          ...
          <li>
            Được đào tạo chuyên sâu về thương mại điện tử và các kỹ năng mềm.
          </li>
          <li>
            Cơ hội tiếp cận các kênh digital marketing như SEO, Google Ads,
      ...
      <div className="working-hours">
        ...
        <p>
          8h30 - 17h30 từ thứ 2 - thứ 6 và hai ngày thứ 7 đầu và cuối tháng.
        </p>
      </div>
      ...
      <div className="how-to-apply">
        <p>
          Nếu bạn đang tìm kiếm cơ hội thực tập có ý nghĩa và muốn thách thức
          bản thân trong môi trường năng động của ngành thời trang, hãy gửi hồ
          sơ của bạn ngay hôm nay!
        </p>
      ...
      <div className="closing-remarks">
        <p>
          Chúng tôi mong đợi được hợp tác và xây dựng sự thành công cùng nhau.
          Cảm ơn các bạn đã quan tâm đến{" "}
          <span className="logotuyendung">Quần Áo</span>{" "}
        </p>
      </div>
      ...
      <div className="footer">
        <p>&copy; {new Date().getFullYear()} Quần Áo. All rights reserved.</p>
      </div>
    </div>
  );
}
