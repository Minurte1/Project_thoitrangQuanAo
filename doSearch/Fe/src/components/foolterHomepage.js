        ...
        <div className="container-footer">
          ...
          <div className="foolter">
            <div className="footer-thongtinlienhe">
              {" "}
              <p className="footer-thongtin2">Thông Tin Liên Hệ : 0968575616</p>
              <p className="footer-thongtinlienhe_diachi">Địa chỉ: 37 lê thanh nghị Ha Noi</p>
              <p>Email:quocanhanh1204@gmail.com</p>
              <p>Hotline: 0968575616</p>
            </div>
            <div className="footer-hr"></div>
