...
const thanhToanCartServices = async (
  ...
  try {
    ...
    const [donHangResult] = await connection.execute(
      "INSERT INTO donhang (MAKHACHHANG, NGAYDONHANG, TRANGTHAI, ten, diachi, sodienthoai, ghichu,phuongthucthanhtoan) VALUES (?, ?, 'ChuaGiao', ?, ?, ?, ?,?)",
      [MAKHACHHANG, currentTime, name, diachi, phone,ghichu, phuongthucthanhtoan]
    );
